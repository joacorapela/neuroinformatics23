...
\begin{enumerate}[(a)]
    ...
    \item Here we are sampling from a normal distribution with zero mean. Thus,
        ...
        this is what Figure~\ref{fig:ex1a} shows.
    ...
    \item  The previous item, and all the following ones, study the probability
        ...
        Figure~\ref{fig:typeIIerror}a illustrates Type I
        ...
        deviation 1). The probability density function of the observations
        ...
        Figure~\ref{fig:typeIIerror}a the distribution of
        ...
        \begin{figure}[H]
            \begin{center}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/two_gaussians_mean00.0000_mean12.5000_std10.0000_alpha0.1000_nSamples100.html}{\includegraphics[width=\textwidth]{../figures/two_gaussians_mean00.0000_mean13.5000_std10.0000_alpha0.0500_nSamples100.png}}
                    \caption{Decreasing the probability of type II error by
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/two_gaussians_mean00.0000_mean12.5000_std10.0000_alpha0.1000_nSamples250.html}{\includegraphics[width=\textwidth]{../figures/two_gaussians_mean00.0000_mean12.5000_std10.0000_alpha0.0500_nSamples250.png}}
                    \caption{Decreasing the probability of type II error by
        ...
        Figure~\ref{fig:ex1b_part1}a shows a histogram of p-values for 1000
        ...
        criterion.
        %
        Figure~\ref{fig:ex1b_part1}b shows the pdf of the sample mean under
        ...
        error. Figure~\ref{fig:ex1b_part1}c is identical to
        ...
        increased.  Figure~\ref{fig:ex1b_part1}d shows the probability
        ...
        \begin{figure}[H]
            \begin{center}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/ex1_distributionNormal_popmean0.0000_mean0.1000_nSamples10000_withErrorBars.html}{\includegraphics[width=\textwidth]{../figures/ex1_distributionNormal_popmean0.0000_mean0.1000_nSamples500_withErrorBars.png}}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/two_gaussians_mean00.0000_mean10.1000_std1.0000_alpha0.0500_nSamples10000.html}{\includegraphics[width=\textwidth]{../figures/two_gaussians_mean00.0000_mean10.1000_std1.0000_alpha0.0500_nSamples500.png}}
                    \caption{Distributions of samples means under the null
                    hypothesis that samples come from a $\mathcal{N}(0, 1)$
                    (blue trace) and under the alternative hypothesis that
                    samples come from a $\mathcal{N}(0.1, 1)$ (red trace), for
        ...
        \begin{figure}[H]
            \begin{center}
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/two_gaussians_mean00.0000_mean10.1000_std1.0000_alpha0.0500_nSamples10000.html}{\includegraphics[width=\textwidth]{../figures/two_gaussians_mean00.0000_mean10.0100_std1.0000_alpha0.0500_nSamples10000.png}}
                    \caption{Distributions of samples means under the null
                    hypothesis that samples come from a $\mathcal{N}(0, 1)$
                    (blue trace) and under the alternative hypothesis that
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/ex1_distributionNormal_popmean0.0000_mean0.0100_nSamples10000_withErrorBars.html}{\includegraphics[width=\fig_width]{../figures/ex1_distributionNormal_popmean0.0000_mean0.0100_nSamples50000_withErrorBars.png}}
                    \caption{Histogram of p-values of 1.000 t-tests evaluating if the mean
                ...
                \begin{subfigure}{0.4\textwidth}
                    \centering
                    \href{https://www.gatsby.ucl.ac.uk/~rapela/neuroinformatics/2023/ws1/figures/two_gaussians_mean00.0000_mean10.1000_std1.0000_alpha0.0500_nSamples10000.html}{\includegraphics[width=\textwidth]{../figures/two_gaussians_mean00.0000_mean10.0100_std1.0000_alpha0.0500_nSamples50000.png}}
                    \caption{Distributions of samples means under the null
                    hypothesis that samples come from a $\mathcal{N}(0, 1)$
                    (blue trace) and under the alternative hypothesis that
                    samples come from a $\mathcal{N}(0.01, 1)$ (red trace), for
