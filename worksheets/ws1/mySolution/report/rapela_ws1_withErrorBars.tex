...
\begin{enumerate}[(a)]
    ...
    \item  Please refer to Fig.~\ref{fig:ex1c}.
        ...
        By the central limit theorem, the mean of 10,000 Cauchy random
        variables should be Normally distributed. Therefore, the distribution
        of p-values for samples of 10,000 Cauchy random variables
        (Fig.~\ref{fig:ex1c}a) should be very similar to that for samples of
        10,000 Normal random variables (Fig.~\ref{fig:ex1a}). The reason for
        this difference is explained in Appendix~\ref{sec:clt}.
