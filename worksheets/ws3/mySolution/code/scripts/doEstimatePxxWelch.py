...
def main(argv):
    ...
    parser.add_argument("--fig_filename_pattern", type=str,
                        ...
                        default="../../figures/pxx_welch_duration_{:f}_segLength_{:d}_pid_{:s}_channel_{:d}.{:s}")
    ...
    fig.write_image(fig_filename_pattern.format(duration, segment_length, pid, channel_to_plot, "png"))
    fig.write_html(fig_filename_pattern.format(duration, segment_length, pid, channel_to_plot, "html"))
